defmodule SyntheticManagerWeb.OrganizationLive.Index do
  use SyntheticManagerWeb, :live_view

  alias SyntheticManager.Organizations
  alias SyntheticManager.Organizations.Organization
  ...
  @impl true
  def handle_info({SyntheticManagerWeb.OrganizationLive.FormComponent, {:saved, organization}}, socket) do
